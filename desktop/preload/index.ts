...
const api = {
  ...
  team: {
    ...
    scheduleList: () => ipcRenderer.invoke("team:schedule:list"),
    scheduleCreate: (t: unknown) => ipcRenderer.invoke("team:schedule:create", t),
    scheduleUpdate: (id: string, patch: unknown) => ipcRenderer.invoke("team:schedule:update", id, patch),
    scheduleDelete: (id: string) => ipcRenderer.invoke("team:schedule:delete", id),
    ...
    roomClear: (id: string) => ipcRenderer.invoke("team:room:clear", id),
    roomMsgDelete: (id: string, msgId: string) => ipcRenderer.invoke("team:room:msg-delete", id, msgId),
